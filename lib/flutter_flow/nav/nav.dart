      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => FoodDetailsWidget(
            foodRef: params.getParam(
              'foodRef',
              ParamType.DocumentReference,
              isList: false,
              collectionNamePath: ['businesses', 'food'],
            ),
            bizRef: params.getParam(
              'bizRef',
              ParamType.DocumentReference,
        ...
        FFRoute(
          name: 'bizHome',
          path: '/bizHome',
          builder: (context, params) => const BizHomeWidget(),
        ),
        FFRoute(
          name: 'addProduct',
          path: '/addProduct',
        ...
        FFRoute(
          name: 'productAdded',
          path: '/productAdded',
          builder: (context, params) => const ProductAddedWidget(),
        ),
        FFRoute(
          name: 'foodBooked',
          path: '/foodBooked',
          builder: (context, params) => const FoodBookedWidget(),
        )
